// ================================================================
// ITAÚ CASH - Script de Upload Simplificado
// ================================================================
// Este arquivo usa o sistema compartilhado PdfUploadHandler
// Apenas define a lógica específica do Itaú Cash
// ================================================================
...
async function processFiles() {
  ...
  showLoading(
    true,
    `Processando ${selectedFiles.length} extrato(s) do Itaú Cash...`,
  );
...
window.initializePdfUpload = function () {
  console.log("🔧 Inicializando Itaú Cash Upload Handler...");
