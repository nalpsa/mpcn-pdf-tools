// ================================================================
// JULIUS BÄR - Script de Upload Simplificado
// ================================================================
// Este arquivo usa o sistema compartilhado PdfUploadHandler
// Apenas define a lógica específica do Julius Bär
// ================================================================

console.log('🏛️ Julius Bär - Script carregado');
...
function getApiUrl() {
  return window.PdfProcessorConfig.getEndpoint('/api/JuliusBar/process');
}

// ============================================================
// UI FUNCTIONS ESPECÍFICAS DO JULIUS BÄR
// ============================================================
...
async function processFiles() {
  ...
  try {
    ...
    const filename =
      ...
      `JuliusBar_Transactions_${new Date().toISOString().split('T')[0]}.xlsx`;
...
window.initializePdfUpload = function () {
  console.log('🔧 Inicializando Julius Bär Upload Handler...');
...
console.log('✅ Script julius-bar.js carregado completamente');
